...
img= new ImageIcon(getClass().getResource("photo//msiportal.png"));
  ...
  Object row[][] = {
			                {"L-Msi#001","Msi Modern 14","1,50,000/="},
			                {"L-Msi#002","Msi Modern 15","1,60,000/="},
			                {"L-Msi#003","Msi Modern 16","1,70,000/="},
			                {"L-Msi#004","Msi Prestige 14","1,80,000/="},
			                {"L-Msi#005","Msi Prestige 15","1,90,000/="},
			                {"L-Msi#006","Msi Katana GF66","1,10,000/="},
			                {"L-Msi#007","Msi Summit E15","1,20,000/="},
			                {"L-Msi#008","Msi pulse GL66","1,30,000/="},
			                {"L-Msi#009","Msi Vector Gp66","1,40,000/="},
			                {"L-Msi#0010","Msi Creator Z16","1,00,000/="},
			                {"L-Msi#0011","Msi Raaider GE66","2,00,000/="}
