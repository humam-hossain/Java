...
img= new ImageIcon(getClass().getResource("photo//hpportal.png"));
  ...
  Object row[][] = {
			                {"L-Hp#001","Hp Omen 14","1,50,000/="},
			                {"L-Hp#002","Hp Omen 15","1,60,000/="},
			                {"L-Hp#003","Hp Omen 16","1,70,000/="},
			                {"L-Hp#004","Hp Victus 14","1,20,000/="},
			                {"L-Hp#005","Hp victus 15","1,30,000/="},
			                {"L-Hp#006","Hp Victus 16","1,40,000/="}
