...
img= new ImageIcon(getClass().getResource("photo//dellportal.png"));
  ...
  Object row[][] = {
			                {"L-Dell#001","Dell Inspiron 14","1,00,000/="},
			                {"L-Dell#002","Dell Inspiron 15","1,10,000/="},
			                {"L-Dell#003","Dell Inspiron 16","1,20,000/="},
			                {"L-Dell#004","Dell G4 ","90,000/="},
			                {"L-Dell#005","Dell G5 ","1,30,000/="},
			                {"L-Dell#006","Dell G6 ","1,70,000/="},
			                {"L-Dell#007","Dell G7 ","1,80,000/="}
